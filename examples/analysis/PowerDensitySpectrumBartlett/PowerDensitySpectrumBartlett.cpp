...
#include "toolbox/analysis/PowerDensitySpectrum.hpp"
...
int main()
{
    constexpr std::size_t bartlett = 0;
    ...
    analysis::PowerSpectralDensity<float, fftLength, FFT, TwiddleFactors, bartlett> powerDensitySpectrum(window, samplingTime);
    ...
    figure.title("Power Spectral Density Bartlett - Analysis");
    figure.size(800, 600);
    figure.save("Power Spectral Densit Bartlett - Analysis.pdf");
