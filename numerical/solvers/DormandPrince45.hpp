...
namespace solvers
{
    ...
    namespace detail
    {
                ...
                bool& fsalValid, math::Vector<T, StateSize>& lastStage)
        {
            ...
            StateVector y5{
                x + k1 * (T{ 35 } / T{ 384 } * h) + k3 * (T{ 500 } / T{ 1113 } * h) + k4 * (T{ 125 } / T{ 192 } * h) + k5 * (T{ 2187 } / T{ 6784 } * h * T{ -1 }) + k6 * (T{ 11 } / T{ 84 } * h)
            };

            StateVector k7{ deriv(y5, t + h) };

            StateVector y4{
                x + k1 * (T{ 5179 } / T{ 57600 } * h) + k3 * (T{ 7571 } / T{ 16695 } * h) + k4 * (T{ 393 } / T{ 640 } * h) + k5 * (T{ 92097 } / T{ 339200 } * h * T{ -1 }) + k6 * (T{ 187 } / T{ 2100 } * h) + k7 * (T{ 1 } / T{ 40 } * h)
            };
