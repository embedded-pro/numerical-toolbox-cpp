...
namespace
{
    using RootLocus5x100 = analysis::RootLocus<float, 5, 100>;

    TEST(TestRootLocus, finds_open_loop_poles_of_first_order_system)
    {
        std::array<float, 1> num = { 1.0f };
        std::array<float, 2> den = { 1.0f, 2.0f };
        RootLocus5x100 rootLocus;
    ...
    TEST(TestRootLocus, finds_open_loop_poles_of_second_order_system)
    {
        float wn = 2.0f;
        float zeta = 0.5f;
    ...
    TEST(TestRootLocus, finds_open_loop_zeros)
    {
    ...
    TEST(TestRootLocus, gain_sweep_produces_correct_number_of_steps)
    {
        std::array<float, 1> num = { 1.0f };
    ...
    TEST(TestRootLocus, gain_sweep_covers_range)
    {
        std::array<float, 1> num = { 1.0f };
        std::array<float, 2> den = { 1.0f, 1.0f };
        RootLocus5x100 rootLocus;
    ...
    TEST(TestRootLocus, closed_loop_poles_at_current_gain)
    {
        std::array<float, 1> num = { 1.0f };
        std::array<float, 2> den = { 1.0f, 1.0f };
        RootLocus5x100 rootLocus;
    ...
    TEST(TestRootLocus, loci_move_left_with_increasing_gain_for_first_order)
    {
        std::array<float, 1> num = { 1.0f };
        std::array<float, 2> den = { 1.0f, 1.0f };
        RootLocus5x100 rootLocus;
    ...
    TEST(TestRootLocus, second_order_poles_become_complex_with_high_gain)
    {
        std::array<float, 1> num = { 1.0f };
    ...
    TEST(TestRootLocus, stores_current_gain)
    {
        std::array<float, 1> num = { 1.0f };
        std::array<float, 2> den = { 1.0f, 1.0f };
        RootLocus5x100 rootLocus;
    ...
    TEST(TestRootLocus, works_with_pid_and_first_order_plant)
    {
