...
| [H∞ State-Feedback Control](HInfinityStateFeedback.md)                | Game-theoretic robust state-feedback gain synthesized via bisection on the game-theoretic DARE with an indefinite weight, guaranteeing a hard L2 disturbance-to-error attenuation bound |
